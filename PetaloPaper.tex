...
\author{
\large
\textsc{J. J. Gomez-Cadenas, J.M. Benlloch-Rodriguez, P. Ferrario,  F. Monrabal and J. Toledo}
}
\vspace{-5mm}
\date{}
...
This paper is organised as follows. In section \ref{sec.pet} we describe with some detail the PETALO concept. In section \ref{sec.mc} we show the results of our Monte Carlo simulations, which show the excellent potential of the technology. In section \ref{sec.tof} we discuss the potential of PETALO as TOF device. In \ref{sec.conclu} we conclude. 
