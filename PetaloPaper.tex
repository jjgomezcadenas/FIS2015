...
\usepackage{multirow}
\begin{document}
\title{PETALO, a new Positron Electron TOF Apparatus based in Liquid xenON}

\author{
\large
\textsc{J. J. Gomez-Cadenas and the PETALO collaboration}
}
\vspace{-5mm}
\date{}
